# StellarPath: patient classifier <img src="https://raw.githubusercontent.com/LucaGiudice/supplementary-Simpati/main/images/StellarPath_logo.png" width=350 align="right" style="border:4px solid black;" />
...
**In case of any installation issues:**
...
1. [Introduction to StellarPath's workflow, data and results](https://github.com/LucaGiudice/supplementary-Simpati/blob/main/images/Classification_Mutations_introduction.pdf)
2. [Introduction to StellarPath's how to plot the data](https://github.com/LucaGiudice/supplementary-Simpati/blob/main/images/Classification_Mutations_introduction.pdf)
